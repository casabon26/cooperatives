...
<div class="py-4">
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-4">
                    <h2 class="card-title mb-2" style="font-weight:800; color:#b91c1c; font-size:1.75rem;">Memorandum Circulars</h2>
                ...
                @if($memorandums->count())
                    <div class="memo-list-view">
                        @foreach($memorandums as $memo)
                            <div class="memo-card mb-3" style="padding:1rem; border:1px solid rgba(185,28,28,0.12); border-radius:10px; transition:all .2s ease; display:flex; gap:1rem; align-items:flex-start;">
                                <div class="memo-icon flex-shrink-0" style="width:40px; height:40px; border-radius:8px; background:rgba(185,28,28,0.08); display:flex; align-items:center; justify-content:center;">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h6v6H7z" stroke="#b91c1c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 15V7a2 2 0 0 0-2-2H9" stroke="#b91c1c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="{{ url('/memorandums/'.$memo->id) }}" class="h5 d-block text-decoration-none mb-1" style="color:#b91c1c; font-weight:700; transition:all .2s ease;" onmouseover="this.style.color='#dc2626'" onmouseout="this.style.color='#b91c1c'">{{ $memo->title }}</a>
