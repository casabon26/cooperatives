                ...
                <td>
                    <form method="post" class="d-flex gap-2">
                        ...
                        <select name="role" class="form-select form-select-sm" style="width:200px">
                            ...
                            <option value="cooperative_admin" {{ $u->role==='cooperative_admin' ? 'selected' : '' }}>Cooperative Admin</option>
                            <option value="gov_admin" {{ $u->role==='gov_admin' ? 'selected' : '' }}>Gov Admin</option>
                        </select>
