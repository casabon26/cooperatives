...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="card" style="border: 1px solid rgba(185,28,28,0.12); border-radius: 10px; box-shadow: 0 4px 12px rgba(185,28,28,0.06);">
                <div class="card-header" style="background: linear-gradient(135deg, rgba(185,28,28,0.08) 0%, rgba(239,68,68,0.04) 100%); border-bottom: 1px solid rgba(185,28,28,0.1); padding: 1.25rem;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <div style="width: 40px; height: 40px; border-radius: 8px; background: linear-gradient(135deg, rgba(185,28,28,0.12), rgba(239,68,68,0.08)); display: flex; align-items: center; justify-content: center;">
                            <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 8a3 3 0 100-6 3 3 0 000 6z" stroke="#b91c1c" stroke-width="1.2" fill="none"/>
                                <path d="M2 14s1.5-3 6-3 6 3 6 3" stroke="#b91c1c" stroke-width="1.2" fill="none" stroke-linecap="round"/>
                            </svg>
                        </div>
                        <h5 class="mb-0" style="color: #7f1d1d; font-weight: 700;">Admin Profile</h5>
                    </div>
                </div>
                <div class="card-body" style="padding: 2rem;">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <div style="padding: 10px 12px; background: rgba(185,28,28,0.03); border-radius: 6px; border-left: 3px solid rgba(185,28,28,0.2);">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div style="padding: 10px 12px; background: rgba(185,28,28,0.03); border-radius: 6px; border-left: 3px solid rgba(185,28,28,0.2);">
                                <span class="badge" style="background: linear-gradient(135deg, rgba(185,28,28,0.15), rgba(239,68,68,0.1)); color: #b91c1c; font-weight: 600; padding: 6px 10px;">{{ ucfirst(str_replace('_', ' ', $user->role)) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div style="padding: 12px 14px; background: rgba(185,28,28,0.03); border-radius: 6px; border-left: 3px solid rgba(185,28,28,0.2); min-height: 80px;">
